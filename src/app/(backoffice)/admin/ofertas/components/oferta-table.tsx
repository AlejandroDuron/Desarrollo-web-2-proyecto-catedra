const ofertas = [
  { titulo: "2x1 en desayunos", empresa: "Cafe Aurora", estado: "Pendiente" },
  { titulo: "15% en papeleria", empresa: "Libreria Central", estado: "Aprobada" },
];
        ...
        <tbody className="divide-y divide-slate-100">
          {ofertas.map((oferta) => (
            <tr key={oferta.titulo}>
              ...
              <td className="px-4 py-3 text-slate-600">{oferta.empresa}</td>
